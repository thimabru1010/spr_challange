...
from TimeSformer.timesformer.models.vit_utils import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
from TimeSformer.timesformer.models.helpers import load_pretrained
from TimeSformer.timesformer.models.vit_utils import DropPath, to_2tuple, trunc_normal_
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        # self.head = nn.Linear(embed_dim, num_frames*in_chans*img_size*img_size)
